          ...
          <div className="flex flex-col px-6 pt-20 pb-32 gap-10">
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4 w-full">
              ...
              <input
                ...
                disabled={loading}
                placeholder={submitted ? t('submitted') : t('emailLabel')}
                className="footer-input font-sans bg-transparent w-full text-base text-black placeholder:text-black/80 disabled:opacity-60 pb-2 focus:ring-0 focus:shadow-none"
                style={EMAIL_UNDERLINE_STYLE}
              />
              <motion.button
                type="submit"
